...
$result = mysql_query($query, $GLOBALS['DB']);
$sn=1;
echo"<table width=100% height=650>";
echo"<tr>";
    echo"<td align=center><img src=../img/crawl.png /></td>"; 
    echo"</tr>";
  echo"<tr>";
    echo"<td align=center valign=middle colspan=2><table width=70% id=indexer>";
      echo"<tr id=indexerHeader>";
        echo"<th>S/N</th>";
        echo"<th>Action</th>";
        echo"<th>Dcument</th>";
        echo"<th>Status</th>";
...
while ($row = mysql_fetch_array($result))
{ 
   echo"<tr class=indexerBody>";
        echo"<td align=center>".$sn."</td>";
        echo"<td align=center>Indexing</td>";
        echo"<td align=center>". $row['DOCUMENT_URL'] ."</td>";
...
echo"<tr>";
      ...
      echo"</tr>";
      echo"<tr class=indexerBody>";
        echo"<th colspan=4 align=center>Indexing complete</th>";
      echo"</tr>";
    echo"</table></td>";
  echo"</tr>";
echo"</table>";
?>
<center><a href="admin.php">[ Back to Admin Page ]</a>&nbsp;&nbsp;&nbsp;<a href=logout.php>[ Log Out ]</a></center>