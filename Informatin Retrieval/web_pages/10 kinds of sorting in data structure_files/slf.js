...
var ANRDF=1;
var ANSCC="unescape(isSocialNetworkShared()+document.referrer+document.location.href+catmanduLogger()+catmandu_integration_mcc(aolTacRef(), document.location.href, 'query=([^&]+)')).toLowerCase()";
var ANTPUD;
var ANVDT=0;
var CCLOOKUP22='AAJSwiki.answers.com|AECIfacebook.com|AEUMtwitter.com|AFIXsocialnetwork:share:facebook:read|TECM|TECI:facebook|UFILgoogleplus|UECKlifestream|UEUMtwitter|UEWTfacebook:like|[FIQok:recommend|UFIWstumbleupon';
var ANAXLSL='';
var ANCB1=0;
var ANCB3=0;
var ANRD='';
...
var CMMISS=-1;
var CMKW="";
function catmandu_integration_mcc(ref,site,sitesearch,app){
if(!app){app="TACODA_CC1";}
if(document.location.href.search(/^[https]{5}/i)>-1){
return"";
}
...
CMREQ(ANCMU1+escape(app)+ANCMU2+escape(kw));
}
return"";
}
function PROCNORM(){
