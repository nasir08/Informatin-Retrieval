DROP TABLE IF EXISTS CPT_SEARCH_CRAWL;
DROP TABLE IF EXISTS CPT_SEARCH_STOP_WORD;
DROP TABLE IF EXISTS CPT_SEARCH_INDEX;
DROP TABLE IF EXISTS CPT_SEARCH_DOCUMENT;
DROP TABLE IF EXISTS CPT_SEARCH_TERM;
...
CREATE TABLE CPT_SEARCH_INDEX (
    ...
    FOREIGN KEY (TERM_ID)
        REFERENCES CPT_SEARCH_TERM(TERM_ID),

    FOREIGN KEY (DOCUMENT_ID)
        REFERENCES CPT_SEARCH_DOCUMENT(DOCUMENT_ID)
)
ENGINE=InnoDB DEFAULT CHARACTER SET latin1
    COLLATE latin1_general_cs;
